...
if menu == "Kesekjenan":
    def kesekjenan():
        gambar_urls = [
            "https://drive.google.com/uc?export=view&id=1T779zcre4ABKNJTATkIPVMzI_1fnDAIG",
            "https://drive.google.com/uc?export=view&id=1hyjXZIFQj3BEO3RG8Fei1PBYsuag6Ioe"
        ]
        data_list = [
            {
                "nama": "Kakak A",
                "deskripsi": "Kakak ini seru."
            },
            {
                "nama": "Kakak B",
                "deskripsi": "Kakak ini juga seru."
            }
        ]
    ...
    def baleg():
        ...
        data_list = [
            ...
            {
                "nama": "Kakak D",
                "deskripsi": "Kakak ini juga hebat."
            }
        ]
        display_images_with_data(gambar_urls, data_list)
    baleg()
